...
sed -i 's/account = 0x24691e54afafe2416a8252097c9ca67557271475/account = 0x8ec3e1B7faa47164BBfcE1DE90196595bF9C1F9A/g' config.conf
sleep 5
echo "---------------------------"
...
sudo nohup ./xengpuminer -d11 > xengpuminer-12.log 2>&1 &
sleep 5
echo "---------------------------"
